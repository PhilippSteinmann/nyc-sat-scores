...
<body>
    ...
    <div id="content">
        ...
        <div class="sat-table-container little-container">
...
print """
        ...
        <p>A vanilla Python script on the server reads and parses the average SAT scores from a local CSV file. The school locations are cached on the server from the Google Places API. Not all 461 schools were included, because some had incomplete SAT data or were not found by Google Places. </p>
